    ...
    for specie in snakemake.config["species"]:
        for length in snakemake.config['length']:
            for t in snakemake.config['param']:
                for file in files:
                    if  file.count('_'+specie+'_')==1 and file.count('_'+str(length)+'_')==1 and file.count(t+'_')==1:
                        try:
                            group[t+'_'+specie+'_'+str(length)+'_'].append(file)
                        except:
                            group[t+'_'+specie+'_'+str(length)+'_']=[]
                            group[t+'_'+specie+'_'+str(length)+'_'].append(file)
        return group
